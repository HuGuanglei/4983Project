...
<?php 
  ...
  $pError = $opError = "";
  $sql = "SELECT * FROM login where username ='$_SESSION[adminName]' ";
  ...
  if(isset($_POST['submit']))
  {
    ...
    if($opError=="" && $pError=="")
    {
      $sql="UPDATE login SET password='$_POST[nPass]' WHERE username='$_SESSION[adminName]' ";
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="changePassAdmin.php">Change Password</a></li>
